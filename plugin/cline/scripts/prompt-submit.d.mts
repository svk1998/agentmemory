...
//#endregion
//#region src/hooks/cline/prompt-submit.d.ts
declare function run(input: HookInput, ctx: Ctx, injectOnPrompt: boolean): Promise<HookOutput>;
//#endregion
export { run };
//# sourceMappingURL=prompt-submit.d.mts.map